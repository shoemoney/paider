...
| 🧪 test suite | ✅ **315 passing**, 1107 assertions | hermetic by default; 3 live tests via `vendor/bin/pest --group=live` |
...
**Hermetic suite** (`vendor/bin/pest`, 315 tests) — all provider interactions mocked via Guzzle;

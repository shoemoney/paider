...
| 🧪 test suite | ✅ **226 passing**, 937 assertions | hermetic by default; 3 live tests via `vendor/bin/pest --group=live` |
...
**Hermetic suite** (`vendor/bin/pest`, 226 tests) — all provider interactions mocked via Guzzle;

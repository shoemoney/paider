...
[![tests](https://img.shields.io/badge/tests-430%20passing-brightgreen?style=for-the-badge)](tests/)
...
| 🧪 test suite | ✅ **430 passing**, 2489 assertions | hermetic by default; 3 live tests via `vendor/bin/pest --group=live` |
...
**Hermetic suite** (`vendor/bin/pest`, 430 tests) — all provider interactions mocked via Guzzle;
...
<details>
<summary><b>❓ Why is v0.1 still 🔨 when the code is written and 430 tests pass?</b></summary>

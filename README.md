...
| 🧪 test suite | ✅ **325 passing**, 1137 assertions | hermetic by default; 3 live tests via `vendor/bin/pest --group=live` |
...
**Hermetic suite** (`vendor/bin/pest`, 325 tests) — all provider interactions mocked via Guzzle;

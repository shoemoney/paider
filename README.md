...
| 🧪 test suite | ✅ **223 passing**, 932 assertions | hermetic by default; 3 live tests via `vendor/bin/pest --group=live` |
...
**Hermetic suite** (`vendor/bin/pest`, 223 tests) — all provider interactions mocked via Guzzle;

...
| 🧪 test suite | ✅ **332 passing**, 1153 assertions | hermetic by default; 3 live tests via `vendor/bin/pest --group=live` |
...
**Hermetic suite** (`vendor/bin/pest`, 332 tests) — all provider interactions mocked via Guzzle;

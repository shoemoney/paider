...
it('matches every number in the README\'s $ paider cost mockup', function () {
    ...
    expect($output)->toContain('14')->toContain('61.2k')->toContain('19.8k')->toContain('$0.801')->toContain('19.8%')
        ->and($output)->toContain('203')->toContain('1.4M')->toContain('287.1k')->toContain('$2.970')->toContain('73.3%')
        ->and($output)->toContain('118')->toContain('1.8M')->toContain('34.6k')->toContain('$0.262')->toContain('6.5%')
        ->and($output)->toContain('77')->toContain('98.4k')->toContain('12.2k')->toContain('$0.017')->toContain('0.4%')
        ...
        ->and($output)->toContain('353.7k')->toContain('$4.050')
        // summary lines
        ->and($output)->toContain('97.8% of your tokens went through tiers costing 80.2% of your spend.')
        ->and($output)->toContain('Same work on all-Opus 5: $25.64')
        ->and($output)->toContain('you saved $21.59');
});
